        ...
        <div className='container jumbo col-xs-12 col-sm-12 col-md-12 col-lg-12 mb-0'>
            ...
            <h1 className='txt'>I design and build digital products</h1>
                ...
                <div>
                    ...
                    <p className='aboutTxt'>Hi, Im Brandon. I'm a multi skilled front end Developer with Backend Experience as well. JavaScript is my Primary language and so far React.js has been my favorite framework to work with. I'm fascinated by the possibilities, I love working on New Projects, and testing the waters to see if there is a way to breathe life into the things I envision. </p>
